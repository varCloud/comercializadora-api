namespace comercializadora_api.Services.Exportacion
{
    ...
    public class ExportacionOptions
    {
        ...
        /// que solicitaba el reporte (esa columna sigue viva en <c>Usuario.Correo</c> hoy, pero
        /// reportes como Ventas/Merma no la usan) — todo se envía a una lista de distribución fija
        /// configurada por ambiente. El primer correo de la lista va como destinatario principal
        /// (To); el resto como copia oculta (Bcc). Configurar en
        /// <c>appsettings.{Environment}.json</c>/User Secrets; vacío deshabilita el envío diferido
